...
<label class="col-md-4 col-form-label text-md-left">{!! $KategoriArtikel->user_id !!}</label>
</div>
<div class="from-group row ">
<label class="col-md-4 col-form-label text-md-right">Crate</label>
<label class="col-md-4 col-form-label text-md-left">{!! $KategoriArtikel->create_at !!}</label>
</div>
<div class="from-group row ">
<label class="col-md-4 col-form-label text-md-right">Update</label>
<label class="col-md-4 col-form-label text-md-left">{!! $KategoriArtikel->update_at !!}</label>
</div>
